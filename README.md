...
📊 HR Analytics Dashboard: Workforce Insights & People Metrics  
A dynamic and interactive Power BI dashboard built to analyze key HR metrics such as headcount, salary distribution, employee demographics, hiring trends, and workforce composition to support data-driven HR decisions.

2. Short Description / Purpose  
The HR Analysis Dashboard is a visually engaging and analytical Power BI report designed to help users understand the structure, diversity, and growth of an organization’s workforce. The dashboard focuses on highlighting major HR KPI’s like Total Headcount, Average Salary, Leave Balance, Gender Distribution, Age Distribution, Qualification vs Salary, and Hiring Trends over time.
...
⚪🧠 DAX (Data Analysis Expressions) – Used for calculated measures such as headcount, averages, and cumulative trends  
⚪📄 Data Modelling – Relationships created between staff and qualification tables to enable accurate analysis  
